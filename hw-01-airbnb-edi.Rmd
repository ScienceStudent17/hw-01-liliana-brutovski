...
ggplot(data = edibnb, mapping = aes(x = price)) +
  ...
  facet_wrap(~neighbourhood, nrow = 3)
````

I chose this layout for my facets because it allows for direct comparison with ease. The differences between the Airbnb price distribution in each neighbourhood are able to be seen and compared with minimal distortion.
